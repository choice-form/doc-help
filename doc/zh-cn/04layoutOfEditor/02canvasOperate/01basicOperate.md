...
|快速断开连线| 鼠标放在连线的开头或结尾一端，当连线出现红色或绿色时按住该连线进行拖拽，会将该连线对应的一端脱离原有端口，拖到画布空白区域释放，连线会被断开，如果放到连线的中间，连线变黑时，是无法拖动的|
|快速转接连线|鼠标放在连线的开头或结尾一端，当连线出现红色或绿色时按住该连线进行拖拽，会将该连线对应的一端脱离原有端口，这时候将连线拖到另外的端口上再释放，就能将该连线转接到另外的端口，如果放到连线的中间，连线变黑时，是无法拖动的 |
